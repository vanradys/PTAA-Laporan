 ...
 */
export const listTodoTasks = async ( options?: RequestInit): Promise<TodoTask[]> => {
...
export const getListTodoTasksQueryOptions = <TData = Awaited<ReturnType<typeof listTodoTasks>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listTodoTasks>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListTodoTasksQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listTodoTasks>>> = ({ signal }) => listTodoTasks({ signal, ...requestOptions });
...
export function useListTodoTasks<TData = Awaited<ReturnType<typeof listTodoTasks>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listTodoTasks>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const getTodoTask = async (id: number, options?: RequestInit): Promise<TodoTask> => {
...
export const getGetTodoTaskQueryOptions = <TData = Awaited<ReturnType<typeof getTodoTask>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTodoTask>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTodoTaskQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTodoTask>>> = ({ signal }) => getTodoTask(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTodoTask>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTodoTaskQueryResult = NonNullable<Awaited<ReturnType<typeof getTodoTask>>>
...
export function useGetTodoTask<TData = Awaited<ReturnType<typeof getTodoTask>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTodoTask>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const updateTodoChecklist = async (taskId: number,
    itemId: number,
    todoChecklistUpdate: TodoChecklistUpdate, options?: RequestInit): Promise<TodoChecklistItem> => {

  return customFetch<TodoChecklistItem>(getUpdateTodoChecklistUrl(taskId,itemId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateTodoChecklistMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTodoChecklist>>, TError,{taskId: number;itemId: number;data: BodyType<TodoChecklistUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateTodoChecklist>>, TError,{taskId: number;itemId: number;data: BodyType<TodoChecklistUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateTodoChecklist>>, {taskId: number;itemId: number;data: BodyType<TodoChecklistUpdate>}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateTodoChecklistMutationResult = NonNullable<Awaited<ReturnType<typeof updateTodoChecklist>>>
 ...
 * @summary Update to-do checklist item
 */
export const useUpdateTodoChecklist = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTodoChecklist>>, TError,{taskId: number;itemId: number;data: BodyType<TodoChecklistUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const createTodoComment = async (id: number,
    todoCommentInput: TodoCommentInput, options?: RequestInit): Promise<TodoComment> => {
...
export const getCreateTodoCommentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTodoComment>>, TError,{id: number;data: BodyType<TodoCommentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createTodoComment>>, TError,{id: number;data: BodyType<TodoCommentInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createTodoComment>>, {id: number;data: BodyType<TodoCommentInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateTodoCommentMutationResult = NonNullable<Awaited<ReturnType<typeof createTodoComment>>>
 ...
 * @summary Add a comment to a to-do task
 */
export const useCreateTodoComment = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTodoComment>>, TError,{id: number;data: BodyType<TodoCommentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
